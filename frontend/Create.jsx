		...
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<div class="col-12">
				...
				<div class="col-12">
					...
					<input type="password" class="form-control" id="inputPassword1123" placeholder='Enter Password'
					 onChange={e => setData({...data, password: e.target.value})}/>
				</div>
				<div class="col-12">
					<label for="inputPassword4" class="form-label">Url</label>
					<input type="text" class="form-control" id="inputPassword122" placeholder='Enter Url'
					 onChange={e => setData({...data, url: e.target.value})}/>
				</div>
				<div class="col-12">
					<label for="inputPassword4" class="form-label">Description</label>
					<input type="text" class="form-control" id="inputPassword12" placeholder='Enter Description'
